  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === "ArrowDown" && currentIndex < projects.length - 1) {
        e.preventDefault();
        const nextSection = containerRef.current?.children[
          currentIndex + 1
        ] as HTMLElement;
        ...
        e.preventDefault();
        const prevSection = containerRef.current?.children[
          currentIndex - 1
        ] as HTMLElement;
              ...
              .map((project, idx) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      const section = containerRef.current?.children[
                        globalIndex
                      ] as HTMLElement;
                      section?.scrollIntoView({ behavior: "smooth" });
